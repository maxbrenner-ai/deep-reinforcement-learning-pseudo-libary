...
agent = DQN(double_dqn=True, model=model, optimizer=optimizer, policy=policy, gamma=0.95, target_model_update_policy='soft', target_model_hard_policy_wait=200, target_model_soft_policy_constant=0.9, max_memory_length=1000)
...
agent.test(env, 1000, 500, print_rew_cb=rew_cb, visualize=False, allow_printing=True)
